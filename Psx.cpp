...
unsigned int Psx::read()
{
  ...
  _data_Right_LR = shift(0xFF);
  _data_Right_UD = shift(0xFF);
  _data_Left_LR = shift(0xFF);
  _data_Left_UD = shift(0xFF);
...
//210321 fujigya2 add get function
byte Psx::getRightLR()
{
  return _data_Right_LR;
}
byte Psx::getRightUD()
{
  return _data_Right_UD;
}
byte Psx::getLeftLR()
{
  return _data_Left_LR;
}
byte Psx::getLeftUD()
{
  return _data_Left_UD;
}
